...
const Blog: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    {
      id: 7,
      title: 'महिला सक्षमीकरणासाठी कार्यशाळा',
      excerpt: 'महिलांसाठी विशेष कार्यशाळा आयोजित करण्यात आली. स्वावलंबन आणि नेतृत्वगुण यावर भर.',
      category: 'समाजसेवा',
      date: '1 जुलै 2025',
      author: 'स्मिता पाटील',
      icon: '👩‍💼',
    ...
    {
      id: 8,
      title: 'गणेश मूर्ती सजावट स्पर्धा',
      excerpt: 'यावर्षीच्या गणेशोत्सवात पारंपरिक आणि पर्यावरणपूरक सजावटीला प्रोत्साहन.',
      category: 'उत्सव',
      date: '25 जून 2025',
      author: 'अजय देशमुख',
      icon: '🎨',
    ...
    {
      id: 9,
      title: 'आरोग्य तपासणी शिबिर यशस्वी',
      excerpt: 'मंडळाच्या वतीने मोफत आरोग्य तपासणी शिबिराचे आयोजन. अनेक नागरिकांनी लाभ घेतला.',
      category: 'समाजसेवा',
      date: '10 जून 2025',
      author: 'डॉ. नीला शहा',
      icon: '🏥',
    ...
    {
      id: 10,
      title: 'युवांसाठी डिजिटल कार्यशाळा',
      excerpt: 'तरुणांसाठी डिजिटल कौशल्ये आणि सोशल मीडिया वापरावर मार्गदर्शन.',
      category: 'तंत्रज्ञान',
      date: '1 जून 2025',
      author: 'राहुल पाटील',
      icon: '📱',
    ...
    {
      id: 11,
      title: 'पर्यावरण दिन विशेष उपक्रम',
      excerpt: 'पर्यावरण दिनानिमित्त वृक्षारोपण, स्वच्छता मोहीम आणि जनजागृती.',
      category: 'पर्यावरण',
      date: '5 जून 2025',
      author: 'मयूरा जोशी',
      icon: '🌳',
    ...
    {
      id: 12,
      title: 'युवा नेतृत्व स्पर्धा',
      excerpt: 'युवकांसाठी नेतृत्वगुण वाढवणारी स्पर्धा आणि पुरस्कार वितरण.',
      category: 'युवा',
      date: '20 मे 2025',
      author: 'संदीप शिंदे',
      icon: '🏆',
